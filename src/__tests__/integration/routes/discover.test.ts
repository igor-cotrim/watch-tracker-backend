...
describe('Discover routes', () => {
  ...
  describe('GET /api/discover', () => {
    ...
    it('passes page as integer', async () => {
      ...
      expect(mockTmdb.discover).toHaveBeenCalledWith(expect.objectContaining({ page: 2 }));
    });
  ...
  describe('GET /api/discover/trending', () => {
    it('defaults type=all and time_window=week', async () => {
      ...
      expect(mockTmdb.getTrending).toHaveBeenCalledWith('all', 'week');
    });
    ...
    it('accepts type=movie', async () => {
      ...
      expect(mockTmdb.getTrending).toHaveBeenCalledWith('movie', 'week');
    });
    ...
    it('accepts time_window=day', async () => {
      ...
      expect(mockTmdb.getTrending).toHaveBeenCalledWith('all', 'day');
    });
  ...
  describe('GET /api/discover/top-rated', () => {
    it('returns results for movie (default)', async () => {
      ...
      expect(res.status).toBe(200);
      expect(mockTmdb.getTopRated).toHaveBeenCalledWith('movie', undefined);
    });
    ...
    it('passes page param', async () => {
      ...
      expect(mockTmdb.getTopRated).toHaveBeenCalledWith('movie', 3);
    });
  ...
  describe('GET /api/discover/upcoming', () => {
    ...
    it('passes page param', async () => {
      ...
      expect(mockTmdb.getUpcoming).toHaveBeenCalledWith(2);
    });
  });
  ...
  describe('GET /api/discover/popular', () => {
    it('returns results for movie (default)', async () => {
      ...
      expect(res.status).toBe(200);
      expect(mockTmdb.getPopular).toHaveBeenCalledWith('movie', undefined);
    });
    ...
    it('returns results for tv', async () => {
      ...
      expect(mockTmdb.getPopular).toHaveBeenCalledWith('tv', undefined);
    });
  ...
  describe('GET /api/discover/genres', () => {
    ...
    it('returns genres for tv', async () => {
      ...
      expect(mockTmdb.getGenres).toHaveBeenCalledWith('tv');
    });
  ...
  describe('GET /api/discover/providers', () => {
    it('calls getWatchProviders with region=BR', async () => {
      ...
      expect(mockTmdb.getWatchProviders).toHaveBeenCalledWith('movie', 'BR');
    });
    ...
    it('accepts type=tv', async () => {
      ...
      expect(mockTmdb.getWatchProviders).toHaveBeenCalledWith('tv', 'BR');
    });
  ...
  describe('GET /api/discover/search', () => {
    it('returns results for valid query', async () => {
      ...
      expect(res.status).toBe(200);
      expect(mockTmdb.search).toHaveBeenCalledWith('batman', undefined, undefined);
    });
    ...
    it('passes type and year params', async () => {
      ...
      expect(mockTmdb.search).toHaveBeenCalledWith('batman', 'movie', 2022);
    });
    ...
    it('treats unknown type as undefined (multi search)', async () => {
      ...
      expect(mockTmdb.search).toHaveBeenCalledWith('test', undefined, undefined);
    });
  });
